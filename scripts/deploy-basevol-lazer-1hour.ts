...
/*
 ...
 This script deploys BaseVolOneHour (Lazer) using the OLD UUPS proxy pattern.
 ...
 Original commands (LEGACY):
   npx hardhat run --network base_sepolia scripts/deploy-basevol-lazer-1hour.ts
   npx hardhat run --network base scripts/deploy-basevol-lazer-1hour.ts
*/
...
const main = async () => {
  ...
  console.log("This script deploys BaseVolOneHour (Lazer) using the LEGACY UUPS proxy pattern.");
  console.log("");
