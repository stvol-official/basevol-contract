...
/*
 ...
 This script deploys BaseVolOneHour using the OLD UUPS proxy pattern.
 ...
 Original commands (LEGACY):
   npx hardhat run --network base_sepolia scripts/deploy-basevol-1hour.ts
   npx hardhat run --network base scripts/deploy-basevol-1hour.ts
*/
...
const main = async () => {
  ...
  console.log("This script deploys BaseVolOneHour using the LEGACY UUPS proxy pattern.");
  console.log("");
