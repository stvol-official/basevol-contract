...
import { BaseVolOneHourStorage } from "../storage/BaseVolOneHourStorage.sol";
  ...
  IBaseVolErrors
{
  ...
  modifier onlyAdmin() {
    BaseVolOneHourStorage.Layout storage $ = BaseVolOneHourStorage.layout();
